...
contract USDTForkTest is BasicDeploy {
    ...
    address constant LINK_WETH_POOL = 0xa6Cc3C2531FdaA6Ae1A3CA84c2855806728693e8; // LINK/WETH pool
    address constant WETH_USDT_POOL = 0x4e68Ccd3E89f51C3074ca5072bbAC773960dFa36; // WETH/USDT 0.3% pool
    address constant USDT_USDC_POOL = 0x3416cF6C708Da44DB2624D63ea0AAef7113527C6; // USDT/USDC 0.01% pool
    ...
    function test_RealMedianPriceBTC() public {
        ...
        assertEq(actualPrice, chainlinkPrice, "WBTC price should be Chainlink only");
    }
    ...
    function test_getAnyPoolTokenPriceInUSD_ETHUSDT() public {
        ...
        assertTrue(ethPriceInUSD > 1200 * 1e6, "ETH price should be greater than $1200 (should be ~$2500)");
    ...
    function test_getAnyPoolTokenPriceInUSD_WBTCETH() public {
        ...
        console2.log("WBTC price in USD (Chainlink only, no USDT pool):", wbtcPriceInUSD);
    ...
    function test_getAnyPoolTokenPriceInUSD_WBTCUSDT() public {
        uint256 wbtcPriceInUSD = assetsInstance.getAssetPrice(WBTC);
        // Log the WBTC price in USD
        console2.log("WBTC price in USD (Chainlink only, no direct USDT pool):", wbtcPriceInUSD);
